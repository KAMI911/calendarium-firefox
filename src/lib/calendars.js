/*
 * calendars.js — Alternative calendar conversions for Calendarium
 *
 * Ported verbatim (algorithm byte-identical) from the calendarium@kami911
 * Cinnamon desklet's lib/calendars.js, wrapped as an ES module.
 *
 ...
 *   • French Republican calendar (equinox-based, Firefox-only addition —
 ...
 * with the sole exception of the French Republican calendar, which is
 * inherently astronomical (its year boundary is the true autumnal equinox,
 * not an arithmetic rule) and so is built on solstice.js's Meeus-algorithm
 * equinox calculator instead.
 */
...
export const Calendars = {
    ...
    // French Republican month names (Fabre d'Églantine, Year II) — these are
    // historical French terms, displayed as-is regardless of interface
    // language (see localization.js's doc comment on "cultural data").
