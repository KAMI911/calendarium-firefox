/*
 * localization.js — Traditional / historical month names for Calendarium
 *
 * Ported verbatim from the calendarium@kami911 Cinnamon desklet's
 * lib/localization.js, wrapped as an ES module.
 *
 * These names are cultural data and are NOT routed through the i18n API;
 ...
 *   2. Add the corresponding option to settings/schema.js under "traditional-lang".
 */
